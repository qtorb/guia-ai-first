  ...
  return (
    <div className="pagina ancha">
      ...
      <div className="mapa-grid">
        ...
        <div className="mapa-caja">
          <p className="rotulo">Te acompaña cada semana</p>
          <h3>Esta web</h3>
          <p>Rellena esa carpeta contigo, paso a paso, y te sitúa cuando vuelves. Si entras
            con tu cuenta, te escribe cada semana el día de tu checkpoint, con sus cuatro
            preguntas, hasta que le digas que pare.</p>
